...
//                     {(movie.boxOfficeRank || movie.high_rating_rank || movie.weather_rank) && (
//                       <div className="rank-label">{movie.boxOfficeRank || movie.high_rating_rank || movie.weather_rank}</div>
//                     )}
